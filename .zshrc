...
prompt_benito() {
  local content='\uf6e4 \uf0e7 Benito'
  $1_prompt_segment "$0" "$2" "black" "202" "$content" "#" 
}
...
zsh_internet_signal(){
    ...
    echo -n "%{$color%}\uf424 %{%f%}%{$text%}$signal" 
}

POWERLEVEL9K_CUSTOM_INTERNET_SIGNAL="zsh_internet_signal"
POWERLEVEL9K_CUSTOM_INTERNET_SIGNAL_BACKGROUND="237"
...
POWERLEVEL9K_CUSTOM_BATTERY_STATUS_BACKGROUND="237"
...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(benito custom_internet_signal custom_battery_status_joined ssh root_indicator dir dir_writable vcs)
